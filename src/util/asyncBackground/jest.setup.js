/**
 * To support web workers in jest, tried using the `jsdom-worker` package, but
 * the support for "revokeObjectURL" has been added 2 years ago, but not yet
 * released. So just including the source directly for now. And including the
 * necessary dependencies (mitt, uuid-v4, node-fetch).
 *
 * https://github.com/developit/jsdom-worker/blob/aaf2874b87b4ab6d6d3113cd816e510d447331d3/src/index.js
 */
...
/**
 * This file depends on "node-fetch" which leads to an error about
 * TextDecoder, which is also not bundled in jsdom. So adding here as well.
 *
 * @ts-expect-error
 */
